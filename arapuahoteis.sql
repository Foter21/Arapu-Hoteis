...
CREATE TABLE hospedes (
    ...
    criado_em TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    aceitou_lgpd BOOLEAN NOT NULL DEFAULT TRUE,     
...
(nome, cpf, telefone, email, data_nascimento, nacionalidade, aceitou_lgpd, data_consentimento)
VALUES
('Lais Gabriela Basilio','11111111111','(63) 99111-1111','lais.gabriela@email.com','1998-04-15','Brasileira', TRUE, NOW()),
('Telê Santana','22222222222','(63) 99222-2222','tele.santana@email.com','1995-08-20','Brasileira', TRUE, NOW()),
('Joao Pedro','33333333333','(63) 99333-3333','joao.pedro@email.com','1997-03-10','Brasileira', TRUE, NOW()),
('Mariana Oliveira','44444444444','(62) 99444-4444','mariana.oliveira@email.com','1992-11-25','Brasileira', TRUE, NOW()),
('Carlos Henrique','55555555555','(61) 99555-5555','carlos.henrique@email.com','1989-01-18','Brasileira', TRUE, NOW()),
('Ana Beatriz Santos','66666666666','(63) 99666-6666','ana.beatriz@email.com','1996-07-30','Brasileira', TRUE, NOW()),
('Rafael Martins','77777777777','(62) 99777-7777','rafael.martins@email.com','1988-09-12','Brasileira', TRUE, NOW()),
('Juliana Ferreira','88888888888','(61) 99888-8888','juliana.ferreira@email.com','1993-12-05','Brasileira', TRUE, NOW());


INSERT INTO reservas
(codigo_reserva, checkin_previsto, checkout_previsto,quantidade_hospedes, observacao, status,id_hospede, id_quarto, id_usuario,aceitou_lgpd, data_consentimento)
VALUES

('ARAP001','2026-08-25','2026-08-28',2,'Cliente solicitou quarto silencioso.','CONFIRMADA',1,1,2,TRUE,NOW()),
('ARAP002','2026-08-26','2026-08-30',1,'Hóspede viajando a trabalho.','PENDENTE',2,4,3,TRUE,NOW()),
('ARAP003','2026-08-27','2026-09-02',3,'Reserva para família.','CONFIRMADA',3,7,2,TRUE,NOW()),
('ARAP004','2026-09-01','2026-09-05',2,'Solicitou check-in antecipado.','PENDENTE',4,10,3,TRUE,NOW()),
('ARAP005','2026-09-03','2026-09-07',4,'Família com crianças.','CONFIRMADA',5,13,2,TRUE,NOW()),
('ARAP006','2026-09-05','2026-09-08',2,'Cliente solicitou cama de casal.','PENDENTE',6,16,3,TRUE,NOW()),
('ARAP007','2026-09-10','2026-09-15',3,'Reserva para viagem de negócios.','CONFIRMADA',7,18,2,TRUE,NOW()),
('ARAP008','2026-09-12','2026-09-18',5,'Reserva familiar.','PENDENTE',8,20,1,TRUE,NOW());
...
VALUES
('2026-08-10 11:30:00',840.00,145.00,0.00,985.00,'Checkout realizado normalmente.',1,3),
